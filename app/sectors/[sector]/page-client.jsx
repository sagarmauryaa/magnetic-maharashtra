...
const SectorsClient = ({ filteredData }) => {
  ...
  return filteredData.map((data) => (
    <main key={data.id}>
      <section className={styles.heroSection} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        <div className={styles.heroSectionContainer}>
          <picture id={styles.heroImage} className="anim-imageWrapper">
            <source
          ...
          <div id={styles.heroText}>
            <h2 className={styles.heroHeading} observer-animation="title">
              {data?.heroSection?.headingTitle}
            </h2>
            <p className={styles.heroSubheading} observer-animation="fadeInUpPara">{data?.heroSection?.desc}</p>
          </div>
        </div>        <span className="anim-line -bottom" observer-animation="cssClass" observer-animation-classes="animateSingleLineIn" transform-origin="top left"></span>
      </section>

      {/* Glance */}
      <section className={styles.sectorAtAGlance} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        ...
        <div className={styles.sectorAtAGlanceContainer}>
          <div id={styles.sectionHead}>
            <h2 observer-animation="title">Sector at a Glance</h2>
          </div>
      ...
      {/* Fueling */}
      <section className={styles.sectorsIncentives} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        <div
          className={styles.sectorsIncentivesContentWrapper}
          style={{
            minHeight: "585px",
            aspectRatio: isMobile ? "41/70" : "80/39",
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${isMobile
        ...
        >
          <div id={styles.sectorsIncentivesHeadingContainer}>
            <h2 className={styles.sectorsIncentivesHead} observer-animation="title">Incentives</h2>
            <p className={styles.sectorsIncentivesSubheading} observer-animation="fadeInUpPara">
              Fueling Investment
              <br />
              at every turn
            </p>
          </div>
          <div className={styles.innerContainer} observer-animation="fadeInUpPara">
      ...
      {/* Initiavtives */}
      <section className={styles.initiativesOpportunities} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        ...
        <span className="anim-line -bottom" observer-animation="cssClass" observer-animation-classes="animateSingleLineIn" transform-origin="top left"></span>
        <div className={styles.initiativesOpportunitiesContainer}>
          <div id={styles.sectionHead}>
            <h2 observer-animation="title">New Initiatives & Opportunities</h2>
          </div>
          {data?.fourthSection?.opportunitiesData.map((opportunity) => (
            <div
              key={opportunity.title}
              className={styles.opportunitiesContainer}
              observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass"
            >
              <span className="anim-line -top" observer-animation="cssClass" observer-animation-classes="animateSingleLineIn" transform-origin="top left"></span>

              <div className={styles.sectorsContentContainer}>
                <div className={styles.contentHead} observer-animation="fadeInUpPara">
                  <h3>{opportunity.title}</h3>
                </div>
                <div className={styles.sectorsImageContent} observer-animation="fadeInUpPara">
      ...
      {/* Innovations */}
      <section className={styles.innovationSection} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        <div className={styles.innovationHeader}>
          <div className={styles.innovationHeading}>
            <h2 observer-animation="fadeInUpPara">
              Powerhouses
              <br />
              of Innovation
            </h2>
          ...
          <div className={styles.innovationSubheading}>
            <h3 observer-animation="fadeInUpPara">{data?.fifthSection?.desc}</h3>
          </div>
        </div>
        <div className={styles.innovationContainer} observer-animation="fadeInUpPara">
          ...
          <div className={styles.innovationImageContainer}>
            ...
            {data?.fifthSection?.powerhouseData.map((data, index) => (
              <div
                className={`${styles.supportingText} ${data.dataLocation} ${index === 0 ? styles.visible : styles.hiddenText
                  }`}
                key={data.title}
                data-location={data.dataLocation}
      ...
      {/* Growth Drivers */}
      <section className={styles.growthDrivers} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">

        <span className="anim-line -top" observer-animation="cssClass" observer-animation-classes="animateSingleLineIn" transform-origin="top left"></span>
        <div className={styles.growthDriversContainer}>
          <div
            id={styles.sectionHead}
            className={styles.growthDriversSectionHead} observer-animation="title"
          >
          ...
          <div className={styles.gridDriver}>
            {data?.sixthSection?.growthCardsData.map((cardData, index) => (
              <div className={styles.gridBox} key={cardData.title} observer-animation="fadeInUpPara">
      ...
      {/* Smart Manufacturing */}
      <section className={styles.smartManufacturing} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        <span className="anim-line -top" observer-animation="cssClass" observer-animation-classes="animateSingleLineIn" transform-origin="top left"></span>
        <span className="anim-line -bottom" observer-animation="cssClass" observer-animation-classes="animateSingleLineIn" transform-origin="top left"></span>
        <div className={styles.manufacturingContainer}>
          ...
          <div className={styles.manufacturingContent} observer-animation="fadeInUpPara">
            ...
            <div className={styles.manufacturingText}>
              ...
              <Button tag="a" text={'Learn More'} href={"/aismartmanufacturing"} className={styles.learnMore} />
      ...
      {/* Sustainability */}
      <section className={styles.sustainability} observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass">
        <div className={styles.sustainabilityHeader}>
          <div className={styles.sustainabilityHeading} observer-animation="fadeInUpPara">
            <h2>
        ...
        <div id={styles.sustainabilityGrid}>
          {data?.eightSection?.cardsData.map((cardData) => (
            <div className={styles.sustainabilityItem} key={cardData.desc} observer-animation="fadeInUpPara">
              <h3>
                {cardData.value}
      ...
      {/* Brands */}
      <section  observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass"className={styles.branding}>
        ...
        <div className={styles.brandingGrid}>
          {data?.ninthSection?.brandsData.map((brand) => (
            <div className={styles.brandingText} key={brand.title} observer-animation="fadeInUpPara">
      ...
      {/* Future */}
      <section  observer-animation-repeat="true" observer-animation-classes="animateAllLinesIn, animateImagesIn" observer-animation="cssClass"className={styles.lastSection}>
        <div className={styles.contactUsContainer}>
          <h2 className={styles.sectorContact} observer-animation="fadeInUpPara">
        ...
        <div
          ...
          role="button"
          aria-label="Contact Us" observer-animation="fadeInUpPara"
